...
public class AddBallBlock extends Block {
     ...
     */
    public AddBallBlock(Rectangle rectangle) {
        super(rectangle);
    }
    ...
    public void drawOn(DrawSurface surface) {
        ...
        surface.drawText((int) this.getCollisionRectangle().getUpperLeft().getX() + 5,
                (int) this.getCollisionRectangle().getUpperLeft().getY() + 12, "add ball", 10);
    }
}
